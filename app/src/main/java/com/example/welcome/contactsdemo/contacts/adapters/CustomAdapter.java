package com.example.welcome.contactsdemo.contacts.adapters;
...
import com.example.welcome.contactsdemo.R;
...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Context context, ArrayList<String> contactModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvnumber.setText(contactModelArrayList.get(position));
